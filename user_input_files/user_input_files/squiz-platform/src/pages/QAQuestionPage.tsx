              ...
              <div className="mb-6">
                <div className="relative group inline-block">
                  <img
                    ...
                    alt="Question image"
                    className="max-w-full h-auto rounded-lg border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 transition-colors cursor-pointer"
