      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="category">{t('quiz.category')}</Label>
              <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                <SelectTrigger>
                  <SelectValue placeholder="Kateqoriya seçin" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="" disabled>Kateqoriya seçin</SelectItem>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="md:col-span-2">
                  <Label htmlFor="question-text">{t('quiz.questionText')} *</Label>
                  <Textarea
                    id="question-text"
                    value={questionText}
              ...
              {(questionType === 'text' || questionType === 'math') && (
                <div>
                  <Label htmlFor="correct-answer">{t('quiz.correctAnswer')} *</Label>
                  <Input
                    id="correct-answer"
                    value={correctAnswer}
                    onChange={(e) => setCorrectAnswer(e.target.value)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Cavabın izаhı (əgər varsa)"
                    rows={2}
                  />
                </div>
        ...
        <div className="space-y-4">
          ...
          {questions.map((question, index) => (
            <div key={question.id} className="border rounded-lg p-4">
              ...
              <h5 className="font-medium mb-2">{question.question_text}</h5>
