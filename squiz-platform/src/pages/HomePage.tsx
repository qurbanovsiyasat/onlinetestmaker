...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* CTA Section */}
      <section className="py-24 sm:py-32 bg-primary-600 dark:bg-primary-800">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-primary-100">
                Squiz ilə öyrənmə səy ahətinizi daha da maraqlı və effektiv edəbilərsiniz. 
                Qeydiyyatdan keçin və birinc i quizinizi yaradın!
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <Button variant="ghost" size="lg" className="px-8 py-3 text-base text-white hover:bg-primary-700">
                  Demo izləyin
                </Button>
              </div>
            </motion.div>
