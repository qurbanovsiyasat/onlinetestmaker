-- Migration: recreate_get_categories_by_type_function
-- Created at: 1755686097

-- Drop and recreate the get_categories_by_type function to fix category loading issues
