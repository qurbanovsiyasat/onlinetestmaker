...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for form-attachments" ON storage.objects FOR SELECT USING (bucket_id = 'form-attachments');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for form-attachments" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'form-attachments');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for form-attachments" ON storage.objects FOR UPDATE USING (bucket_id = 'form-attachments');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for form-attachments" ON storage.objects FOR DELETE USING (bucket_id = 'form-attachments');`
    ];
