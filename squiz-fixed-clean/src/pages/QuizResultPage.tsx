...
export default function QuizResultPage() {
  ...
  const incorrectAnswers = result?.quiz?.questions?.filter(q => {
    const { isCorrect } = getAnswerStatus(q.id, q.correct_answer)
    return !isCorrect
  }) || []
                  ...
                  <CardContent className="pt-0">
                    ...
                    <div className="space-y-4">
                      ...
                      {result.quiz.questions.map((question, index) => {
                        const { isCorrect, userAnswer } = getAnswerStatus(question.id, question.correct_answer)
                                  ...
                                  <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                                    ...
                                    <div className="mb-3">
                                      ...
                                      <div className={cn(
                                        ...
                                        <MathRenderer content={userAnswer || "Cavab verilməyib"} />
                                      </div>
                                    </div>
